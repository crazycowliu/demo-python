...
RequestUrl = "http://www.ocrwebservice.com/restservices/processDocument?gettext=true&outputformat=txt";
...
r = requests.post(RequestUrl, data=image_data, auth=(LicenseCode, UserName))
...
with open("outputDoc.csv", 'wb') as output_file:
